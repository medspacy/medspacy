class DbConnect:
    ...
    def __init__(self, driver=None, server=None, db=None, user=None, pwd=None, conn=None):
        ...
        """
        if conn is None:
            # this is currently commented out because of falsy empty strings for passing authentication to SQL
            # triggering this ValueError. If enforcement of parameters gets added back later, it needs to
            # exclude user/pwd or allow empty strings.
