...
class TestQuickUMLSSpanGroupFR:
    def test_span_groups_fr(self):
        """
        ...
        concept_term = "1,2-Dipalmitoylphosphatidylcholine"

        text = "{} découvert pendant la procédure".format(concept_term)
